...
namespace SimplePaint.Shapes
{
    ...
    public class CustomFigure
    {
        ...
        /// </value>
        public LinkedListNode<CustomEllipse> FirstNode { get { return FigureVertices.First; } }
        /// <summary>
        ...
        /// </value>
        public LinkedListNode<CustomEllipse> LastNode { get { return FigureVertices.Last; } }
        /// <summary>
        ...
        /// The first vertex.
        /// </value>
        public CustomEllipse FirstVertex { get { return FirstNode.Value; } }
        /// <summary>
        ...
        /// The last vertex.
        /// </value>
        public CustomEllipse LastVertex { get { return LastNode.Value; } }
        /// <summary>
        ...
        /// <param name="vertex">The vertex.</param>
        /// <returns></returns>
        public CustomEllipse GetPreviousVertex(CustomEllipse vertex)
        {
        ...
        /// </summary>
        /// <param name="vertex">The vertex.</param>
        public void DeleteVertex(CustomEllipse vertex)
        {
        ...
        public static bool IsPointInFigure(Point point, CustomFigure figure)
        {
            ...
            {
                int iX = firstVertex.Value.Position.X;
                int iY = firstVertex.Value.Position.Y;
                int jX = lastVertex.Value.Position.X;
                int jY = lastVertex.Value.Position.Y;
        ...
        public static bool IsVertex(Point point, CustomFigure figure, out CustomEllipse outVertex)
        {
            ...
            foreach (CustomEllipse vertex in figure.FigureVertices.Where(
